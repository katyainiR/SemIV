...
Top_Three<-Ordered_by_page_rank_probabilities_2[1:3]
print("The Page Rank Value of the top three pages in the network is in the Viewing Pane: \n")
suppressWarnings(View(Top_Three))
